...
class Iface(object):
    ...
    def GetBestPlannerAction(self, best_planner_action_request):
        """
        Parameters:
         - best_planner_action_request
...
class Client(Iface):
    ...
    def GetBestPlannerAction(self, best_planner_action_request):
        ...
        return self.recv_GetBestPlannerAction()

    def send_GetBestPlannerAction(self, best_planner_action_request):
        self._oprot.writeMessageBegin('GetBestPlannerAction', TMessageType.CALL, self._seqid)
        args = GetBestPlannerAction_args()
        args.best_planner_action_request = best_planner_action_request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_GetBestPlannerAction(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = GetBestPlannerAction_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "GetBestPlannerAction failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["GetBestPlannerAction"] = Processor.process_GetBestPlannerAction
    ...
    def process_GetBestPlannerAction(self, seqid, iprot, oprot):
        args = GetBestPlannerAction_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = GetBestPlannerAction_result()
        try:
            result.success = self._handler.GetBestPlannerAction(args.best_planner_action_request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("GetBestPlannerAction", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class GetBestPlannerAction_args(object):
    """
    Attributes:
     - best_planner_action_request
    ...
    def __init__(self, best_planner_action_request=None,):
        self.best_planner_action_request = best_planner_action_request
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.best_planner_action_request = BestPlannerActionRequest()
                    self.best_planner_action_request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetBestPlannerAction_args')
        if self.best_planner_action_request is not None:
            oprot.writeFieldBegin('best_planner_action_request', TType.STRUCT, 1)
            self.best_planner_action_request.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetBestPlannerAction_args)
GetBestPlannerAction_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'best_planner_action_request', [BestPlannerActionRequest, None], None, ),  # 1
)


class GetBestPlannerAction_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = BestPlannerActionResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetBestPlannerAction_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetBestPlannerAction_result)
GetBestPlannerAction_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [BestPlannerActionResponse, None], None, ),  # 0
)
