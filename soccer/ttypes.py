...
class HeliosOffensivePlanner(object):
    ...
    def __init__(self, direct_pass=None, lead_pass=None, through_pass=None, short_dribble=None, long_dribble=None, cross=None, simple_pass=None, simple_dribble=None, simple_shoot=None, server_side_decision=None,):
...
class PlayerActions(object):
    ...
    def __init__(self, actions=None, ignore_preprocess=None, ignore_doforcekick=None, ignore_doHeardPassRecieve=None,):
...
class BestPlannerActionRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i80 in range(_size76):
                        ...
                        _val82 = RpcActionState()
                        _val82.read(iprot)
                        self.pairs[_key81] = _val82
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.pairs is not None:
            ...
            for kiter83, viter84 in self.pairs.items():
