...
class RpcActionCategory(object):
    AC_Hold = 0
    AC_Dribble = 1
    AC_Pass = 2
    AC_Shoot = 3
...
class State(object):
    ...
    def __init__(self, register_response=None, world_model=None, full_world_model=None, need_preprocess=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.need_preprocess = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.full_world_model is not None:
            ...
            oprot.writeFieldEnd()
        if self.need_preprocess is not None:
            oprot.writeFieldBegin('need_preprocess', TType.BOOL, 4)
            oprot.writeBool(self.need_preprocess)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class OpponentEffector(object):
    ...
    Attributes:
     ...
     - negetive_effect_by_distance_based_on_first_layer
    ...
    def __init__(self, negetive_effect_by_distance=None, negetive_effect_by_distance_based_on_first_layer=None, negetive_effect_by_reach_steps=None, negetive_effect_by_reach_steps_based_on_first_layer=None,):
        self.negetive_effect_by_distance = negetive_effect_by_distance
        self.negetive_effect_by_distance_based_on_first_layer = negetive_effect_by_distance_based_on_first_layer
        self.negetive_effect_by_reach_steps = negetive_effect_by_reach_steps
        self.negetive_effect_by_reach_steps_based_on_first_layer = negetive_effect_by_reach_steps_based_on_first_layer
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    self.negetive_effect_by_distance = []
                    (_etype58, _size55) = iprot.readListBegin()
                    for _i59 in range(_size55):
                        _elem60 = iprot.readDouble()
                        self.negetive_effect_by_distance.append(_elem60)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
                    self.negetive_effect_by_distance_based_on_first_layer = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    self.negetive_effect_by_reach_steps = []
                    (_etype64, _size61) = iprot.readListBegin()
                    for _i65 in range(_size61):
                        _elem66 = iprot.readDouble()
                        self.negetive_effect_by_reach_steps.append(_elem66)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BOOL:
                    self.negetive_effect_by_reach_steps_based_on_first_layer = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('OpponentEffector')
        if self.negetive_effect_by_distance is not None:
            oprot.writeFieldBegin('negetive_effect_by_distance', TType.LIST, 1)
            oprot.writeListBegin(TType.DOUBLE, len(self.negetive_effect_by_distance))
            for iter67 in self.negetive_effect_by_distance:
                oprot.writeDouble(iter67)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.negetive_effect_by_distance_based_on_first_layer is not None:
            oprot.writeFieldBegin('negetive_effect_by_distance_based_on_first_layer', TType.BOOL, 2)
            oprot.writeBool(self.negetive_effect_by_distance_based_on_first_layer)
            oprot.writeFieldEnd()
        if self.negetive_effect_by_reach_steps is not None:
            oprot.writeFieldBegin('negetive_effect_by_reach_steps', TType.LIST, 3)
            oprot.writeListBegin(TType.DOUBLE, len(self.negetive_effect_by_reach_steps))
            for iter68 in self.negetive_effect_by_reach_steps:
                oprot.writeDouble(iter68)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.negetive_effect_by_reach_steps_based_on_first_layer is not None:
            oprot.writeFieldBegin('negetive_effect_by_reach_steps_based_on_first_layer', TType.BOOL, 4)
            oprot.writeBool(self.negetive_effect_by_reach_steps_based_on_first_layer)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ActionTypeEffector(object):
    ...
    def __init__(self, direct_pass=None, lead_pass=None, through_pass=None, short_dribble=None, long_dribble=None, cross=None, hold=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.DOUBLE:
                    self.direct_pass = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.DOUBLE:
                    self.lead_pass = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.DOUBLE:
                    self.through_pass = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.DOUBLE:
                    self.short_dribble = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.DOUBLE:
                    self.long_dribble = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.DOUBLE:
                    self.cross = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.DOUBLE:
                    self.hold = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ActionTypeEffector')
        if self.direct_pass is not None:
            oprot.writeFieldBegin('direct_pass', TType.DOUBLE, 1)
            oprot.writeDouble(self.direct_pass)
            oprot.writeFieldEnd()
        if self.lead_pass is not None:
            oprot.writeFieldBegin('lead_pass', TType.DOUBLE, 2)
            oprot.writeDouble(self.lead_pass)
            oprot.writeFieldEnd()
        if self.through_pass is not None:
            oprot.writeFieldBegin('through_pass', TType.DOUBLE, 3)
            oprot.writeDouble(self.through_pass)
            oprot.writeFieldEnd()
        if self.short_dribble is not None:
            oprot.writeFieldBegin('short_dribble', TType.DOUBLE, 4)
            oprot.writeDouble(self.short_dribble)
            oprot.writeFieldEnd()
        if self.long_dribble is not None:
            oprot.writeFieldBegin('long_dribble', TType.DOUBLE, 5)
            oprot.writeDouble(self.long_dribble)
            oprot.writeFieldEnd()
        if self.cross is not None:
            oprot.writeFieldBegin('cross', TType.DOUBLE, 6)
            oprot.writeDouble(self.cross)
            oprot.writeFieldEnd()
        if self.hold is not None:
            oprot.writeFieldBegin('hold', TType.DOUBLE, 7)
            oprot.writeDouble(self.hold)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TeammateEffector(object):
    ...
    Attributes:
     - coefficients
     - apply_based_on_first_layer

    """


    def __init__(self, coefficients=None, apply_based_on_first_layer=None,):
        self.coefficients = coefficients
        self.apply_based_on_first_layer = apply_based_on_first_layer
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i73 in range(_size69):
                        ...
                        self.coefficients[_key74] = _val75
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
                    self.apply_based_on_first_layer = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TeammateEffector')
        if self.coefficients is not None:
            oprot.writeFieldBegin('coefficients', TType.MAP, 1)
            oprot.writeMapBegin(TType.I32, TType.DOUBLE, len(self.coefficients))
            for kiter76, viter77 in self.coefficients.items():
                oprot.writeI32(kiter76)
                oprot.writeDouble(viter77)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.apply_based_on_first_layer is not None:
            oprot.writeFieldBegin('apply_based_on_first_layer', TType.BOOL, 2)
            oprot.writeBool(self.apply_based_on_first_layer)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class PlannerEvaluationEffector(object):
    ...
    def __init__(self, opponent_effector=None, action_type_effector=None, teammate_effector=None,):
        self.opponent_effector = opponent_effector
        self.action_type_effector = action_type_effector
        self.teammate_effector = teammate_effector
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.opponent_effector = OpponentEffector()
                    self.opponent_effector.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.action_type_effector = ActionTypeEffector()
                    self.action_type_effector.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.teammate_effector = TeammateEffector()
                    self.teammate_effector.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('PlannerEvaluationEffector')
        if self.opponent_effector is not None:
            oprot.writeFieldBegin('opponent_effector', TType.STRUCT, 1)
            self.opponent_effector.write(oprot)
            oprot.writeFieldEnd()
        if self.action_type_effector is not None:
            oprot.writeFieldBegin('action_type_effector', TType.STRUCT, 2)
            self.action_type_effector.write(oprot)
            oprot.writeFieldEnd()
        if self.teammate_effector is not None:
            oprot.writeFieldBegin('teammate_effector', TType.STRUCT, 3)
            self.teammate_effector.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class HeliosFieldEvaluator(object):
    ...
    Attributes:
     - x_coefficient
     - ball_dist_to_goal_coefficient
     - effective_max_ball_dist_to_goal

    """


    def __init__(self, x_coefficient=None, ball_dist_to_goal_coefficient=None, effective_max_ball_dist_to_goal=None,):
        self.x_coefficient = x_coefficient
        self.ball_dist_to_goal_coefficient = ball_dist_to_goal_coefficient
        self.effective_max_ball_dist_to_goal = effective_max_ball_dist_to_goal
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.DOUBLE:
                    self.x_coefficient = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.DOUBLE:
                    self.ball_dist_to_goal_coefficient = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.DOUBLE:
                    self.effective_max_ball_dist_to_goal = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('HeliosFieldEvaluator')
        if self.x_coefficient is not None:
            oprot.writeFieldBegin('x_coefficient', TType.DOUBLE, 1)
            oprot.writeDouble(self.x_coefficient)
            oprot.writeFieldEnd()
        if self.ball_dist_to_goal_coefficient is not None:
            oprot.writeFieldBegin('ball_dist_to_goal_coefficient', TType.DOUBLE, 2)
            oprot.writeDouble(self.ball_dist_to_goal_coefficient)
            oprot.writeFieldEnd()
        if self.effective_max_ball_dist_to_goal is not None:
            oprot.writeFieldBegin('effective_max_ball_dist_to_goal', TType.DOUBLE, 3)
            oprot.writeDouble(self.effective_max_ball_dist_to_goal)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class MatrixFieldEvaluatorY(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('MatrixFieldEvaluatorY')
        if self.evals is not None:
            oprot.writeFieldBegin('evals', TType.LIST, 1)
            oprot.writeListBegin(TType.DOUBLE, len(self.evals))
            for iter84 in self.evals:
...
class MatrixFieldEvaluator(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i89 in range(_size85):
                        _elem90 = MatrixFieldEvaluatorY()
                        _elem90.read(iprot)
                        self.evals.append(_elem90)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('MatrixFieldEvaluator')
        if self.evals is not None:
            oprot.writeFieldBegin('evals', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.evals))
            for iter91 in self.evals:
                iter91.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class PlannerFieldEvaluator(object):
    ...
    def __init__(self, helios_field_evaluator=None, matrix_field_evaluator=None,):
        self.helios_field_evaluator = helios_field_evaluator
        self.matrix_field_evaluator = matrix_field_evaluator
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.helios_field_evaluator = HeliosFieldEvaluator()
                    self.helios_field_evaluator.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.matrix_field_evaluator = MatrixFieldEvaluator()
                    self.matrix_field_evaluator.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('PlannerFieldEvaluator')
        if self.helios_field_evaluator is not None:
            oprot.writeFieldBegin('helios_field_evaluator', TType.STRUCT, 1)
            self.helios_field_evaluator.write(oprot)
            oprot.writeFieldEnd()
        if self.matrix_field_evaluator is not None:
            oprot.writeFieldBegin('matrix_field_evaluator', TType.STRUCT, 2)
            self.matrix_field_evaluator.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class PlannerEvaluation(object):
    ...
    def __init__(self, effectors=None, field_evaluators=None,):
        self.effectors = effectors
        self.field_evaluators = field_evaluators
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.effectors = PlannerEvaluationEffector()
                    self.effectors.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.field_evaluators = PlannerFieldEvaluator()
                    self.field_evaluators.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('PlannerEvaluation')
        if self.effectors is not None:
            oprot.writeFieldBegin('effectors', TType.STRUCT, 1)
            self.effectors.write(oprot)
            oprot.writeFieldEnd()
        if self.field_evaluators is not None:
            oprot.writeFieldBegin('field_evaluators', TType.STRUCT, 2)
            self.field_evaluators.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class HeliosOffensivePlanner(object):
    ...
    def __init__(self, direct_pass=None, lead_pass=None, through_pass=None, short_dribble=None, long_dribble=None, cross=None, simple_pass=None, simple_dribble=None, simple_shoot=None, server_side_decision=None, max_depth=None, max_nodes=None, evaluation=None,):
        self.direct_pass = direct_pass
        self.lead_pass = lead_pass
        self.through_pass = through_pass
        self.short_dribble = short_dribble
        ...
        self.server_side_decision = server_side_decision
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.server_side_decision = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.I32:
                ...
                if ftype == TType.I32:
                    self.max_nodes = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.STRUCT:
                    self.evaluation = PlannerEvaluation()
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('HeliosOffensivePlanner')
        if self.direct_pass is not None:
        ...
        if self.simple_shoot is not None:
            ...
            oprot.writeFieldEnd()
        if self.server_side_decision is not None:
            oprot.writeFieldBegin('server_side_decision', TType.BOOL, 10)
            oprot.writeBool(self.server_side_decision)
            oprot.writeFieldEnd()
        if self.max_depth is not None:
            oprot.writeFieldBegin('max_depth', TType.I32, 11)
            oprot.writeI32(self.max_depth)
            oprot.writeFieldEnd()
        if self.max_nodes is not None:
            oprot.writeFieldBegin('max_nodes', TType.I32, 12)
            oprot.writeI32(self.max_nodes)
            oprot.writeFieldEnd()
        if self.evaluation is not None:
            oprot.writeFieldBegin('evaluation', TType.STRUCT, 13)
...
class PlayerAction(object):
    ...
    def __init__(self, dash=None, turn=None, kick=None, tackle=None, catch_action=None, move=None, turn_neck=None, change_view=None, say=None, point_to=None, point_to_of=None, attention_to=None, attention_to_of=None, log=None, debug_client=None, body_go_to_point=None, body_smart_kick=None, bhv_before_kick_off=None, bhv_body_neck_to_ball=None, bhv_body_neck_to_point=None, bhv_emergency=None, bhv_go_to_point_look_ball=None, bhv_neck_body_to_ball=None, bhv_neck_body_to_point=None, bhv_scan_field=None, body_advance_ball=None, body_clear_ball=None, body_dribble=None, body_go_to_point_dodge=None, body_hold_ball=None, body_intercept=None, body_kick_one_step=None, body_stop_ball=None, body_stop_dash=None, body_tackle_to_point=None, body_turn_to_angle=None, body_turn_to_ball=None, body_turn_to_point=None, focus_move_to_point=None, focus_reset=None, neck_scan_field=None, neck_scan_players=None, neck_turn_to_ball_and_player=None, neck_turn_to_ball_or_scan=None, neck_turn_to_ball=None, neck_turn_to_goalie_or_scan=None, neck_turn_to_low_conf_teammate=None, neck_turn_to_player_or_scan=None, neck_turn_to_point=None, neck_turn_to_relative=None, view_change_width=None, view_normal=None, view_synch=None, view_wide=None, helios_goalie=None, helios_goalie_move=None, helios_goalie_kick=None, helios_shoot=None, helios_offensive_planner=None, helios_basic_offensive=None, helios_basic_move=None, helios_set_play=None, helios_penalty=None, helios_communication=None, bhv_do_force_kick=None, bhv_do_heard_pass_recieve=None,):
        ...
        self.helios_offensive_planner = helios_offensive_planner
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.helios_offensive_planner = HeliosOffensivePlanner()
                    self.helios_offensive_planner.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 60:
                if ftype == TType.STRUCT:
    ...
    def write(self, oprot):
        ...
        if self.helios_shoot is not None:
            ...
            oprot.writeFieldEnd()
        if self.helios_offensive_planner is not None:
            oprot.writeFieldBegin('helios_offensive_planner', TType.STRUCT, 59)
            self.helios_offensive_planner.write(oprot)
            oprot.writeFieldEnd()
...
class PlayerActions(object):
    ...
    def __init__(self, actions=None, ignore_preprocess=None, ignore_doforcekick=None, ignore_doHeardPassRecieve=None, ignore_doIntention=None, ignore_shootInPreprocess=None,):
        self.actions = actions
        self.ignore_preprocess = ignore_preprocess
        self.ignore_doforcekick = ignore_doforcekick
        self.ignore_doHeardPassRecieve = ignore_doHeardPassRecieve
        self.ignore_doIntention = ignore_doIntention
        self.ignore_shootInPreprocess = ignore_shootInPreprocess
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i96 in range(_size92):
                        _elem97 = PlayerAction()
                        _elem97.read(iprot)
                        self.actions.append(_elem97)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
                    self.ignore_preprocess = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.BOOL:
                    self.ignore_doforcekick = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BOOL:
                    self.ignore_doHeardPassRecieve = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.BOOL:
                    self.ignore_doIntention = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.BOOL:
                    self.ignore_shootInPreprocess = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.actions is not None:
            ...
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.ignore_preprocess is not None:
            oprot.writeFieldBegin('ignore_preprocess', TType.BOOL, 2)
            oprot.writeBool(self.ignore_preprocess)
            oprot.writeFieldEnd()
        if self.ignore_doforcekick is not None:
            oprot.writeFieldBegin('ignore_doforcekick', TType.BOOL, 3)
            oprot.writeBool(self.ignore_doforcekick)
            oprot.writeFieldEnd()
        if self.ignore_doHeardPassRecieve is not None:
            oprot.writeFieldBegin('ignore_doHeardPassRecieve', TType.BOOL, 4)
            oprot.writeBool(self.ignore_doHeardPassRecieve)
            oprot.writeFieldEnd()
        if self.ignore_doIntention is not None:
            oprot.writeFieldBegin('ignore_doIntention', TType.BOOL, 5)
            oprot.writeBool(self.ignore_doIntention)
            oprot.writeFieldEnd()
        if self.ignore_shootInPreprocess is not None:
            oprot.writeFieldBegin('ignore_shootInPreprocess', TType.BOOL, 6)
            oprot.writeBool(self.ignore_shootInPreprocess)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i103 in range(_size99):
                        _elem104 = CoachAction()
                        _elem104.read(iprot)
                        self.actions.append(_elem104)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i110 in range(_size106):
                        _elem111 = TrainerAction()
                        _elem111.read(iprot)
                        self.actions.append(_elem111)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class RpcCooperativeAction(object):
    ...
    def __init__(self, category=None, index=None, sender_unum=None, target_unum=None, target_point=None, first_ball_speed=None, first_turn_moment=None, first_dash_power=None, first_dash_angle_relative=None, duration_step=None, kick_count=None, turn_count=None, dash_count=None, final_action=None, description=None, parent_index=None,):
        self.category = category
        self.index = index
        self.sender_unum = sender_unum
        self.target_unum = target_unum
        self.target_point = target_point
        self.first_ball_speed = first_ball_speed
        self.first_turn_moment = first_turn_moment
        self.first_dash_power = first_dash_power
        self.first_dash_angle_relative = first_dash_angle_relative
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.sender_unum = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
                    self.target_unum = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRUCT:
                ...
                if ftype == TType.DOUBLE:
                    self.first_ball_speed = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.DOUBLE:
                    self.first_turn_moment = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.DOUBLE:
                    self.first_dash_power = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.DOUBLE:
                    self.first_dash_angle_relative = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.I32:
                    self.duration_step = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.I32:
                    self.kick_count = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
                    self.turn_count = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.I32:
                ...
                if ftype == TType.BOOL:
                    self.final_action = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 15:
                if ftype == TType.STRING:
                ...
                if ftype == TType.I32:
                    self.parent_index = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('RpcCooperativeAction')
        ...
        if self.index is not None:
            ...
            oprot.writeFieldEnd()
        if self.sender_unum is not None:
            oprot.writeFieldBegin('sender_unum', TType.I32, 3)
            oprot.writeI32(self.sender_unum)
            oprot.writeFieldEnd()
        if self.target_unum is not None:
            oprot.writeFieldBegin('target_unum', TType.I32, 4)
            oprot.writeI32(self.target_unum)
            oprot.writeFieldEnd()
        if self.target_point is not None:
            oprot.writeFieldBegin('target_point', TType.STRUCT, 5)
            self.target_point.write(oprot)
            oprot.writeFieldEnd()
        if self.first_ball_speed is not None:
            oprot.writeFieldBegin('first_ball_speed', TType.DOUBLE, 6)
            oprot.writeDouble(self.first_ball_speed)
            oprot.writeFieldEnd()
        if self.first_turn_moment is not None:
            oprot.writeFieldBegin('first_turn_moment', TType.DOUBLE, 7)
            oprot.writeDouble(self.first_turn_moment)
            oprot.writeFieldEnd()
        if self.first_dash_power is not None:
            oprot.writeFieldBegin('first_dash_power', TType.DOUBLE, 8)
            oprot.writeDouble(self.first_dash_power)
            oprot.writeFieldEnd()
        if self.first_dash_angle_relative is not None:
            oprot.writeFieldBegin('first_dash_angle_relative', TType.DOUBLE, 9)
            oprot.writeDouble(self.first_dash_angle_relative)
            oprot.writeFieldEnd()
        if self.duration_step is not None:
            oprot.writeFieldBegin('duration_step', TType.I32, 10)
            oprot.writeI32(self.duration_step)
            oprot.writeFieldEnd()
        if self.kick_count is not None:
            oprot.writeFieldBegin('kick_count', TType.I32, 11)
            oprot.writeI32(self.kick_count)
            oprot.writeFieldEnd()
        if self.turn_count is not None:
            oprot.writeFieldBegin('turn_count', TType.I32, 12)
            oprot.writeI32(self.turn_count)
            oprot.writeFieldEnd()
        if self.dash_count is not None:
            oprot.writeFieldBegin('dash_count', TType.I32, 13)
            oprot.writeI32(self.dash_count)
            oprot.writeFieldEnd()
        if self.final_action is not None:
            oprot.writeFieldBegin('final_action', TType.BOOL, 14)
            oprot.writeBool(self.final_action)
            oprot.writeFieldEnd()
        ...
        if self.parent_index is not None:
            oprot.writeFieldBegin('parent_index', TType.I32, 16)
            oprot.writeI32(self.parent_index)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class RpcPredictState(object):
    ...
    def __init__(self, spend_time=None, ball_holder_unum=None, ball_position=None, ball_velocity=None, our_defense_line_x=None, our_offense_line_x=None,):
        self.spend_time = spend_time
        self.ball_holder_unum = ball_holder_unum
        self.ball_position = ball_position
        self.ball_velocity = ball_velocity
        self.our_defense_line_x = our_defense_line_x
        self.our_offense_line_x = our_offense_line_x
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I32:
                    self.spend_time = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I32:
                    self.ball_holder_unum = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                ...
                if ftype == TType.DOUBLE:
                    self.our_offense_line_x = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('RpcPredictState')
        if self.spend_time is not None:
            oprot.writeFieldBegin('spend_time', TType.I32, 1)
            oprot.writeI32(self.spend_time)
            oprot.writeFieldEnd()
        if self.ball_holder_unum is not None:
            oprot.writeFieldBegin('ball_holder_unum', TType.I32, 2)
            oprot.writeI32(self.ball_holder_unum)
            oprot.writeFieldEnd()
        if self.ball_position is not None:
            oprot.writeFieldBegin('ball_position', TType.STRUCT, 3)
            self.ball_position.write(oprot)
        ...
        if self.ball_velocity is not None:
            ...
            oprot.writeFieldEnd()
        if self.our_defense_line_x is not None:
            oprot.writeFieldBegin('our_defense_line_x', TType.DOUBLE, 5)
            oprot.writeDouble(self.our_defense_line_x)
            oprot.writeFieldEnd()
        if self.our_offense_line_x is not None:
            oprot.writeFieldBegin('our_offense_line_x', TType.DOUBLE, 6)
            oprot.writeDouble(self.our_offense_line_x)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class RpcActionState(object):
    ...
    def __init__(self, action=None, predict_state=None, evaluation=None,):
        self.action = action
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.action = RpcCooperativeAction()
                    self.action.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.predict_state = RpcPredictState()
                    self.predict_state.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.DOUBLE:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('RpcActionState')
        if self.action is not None:
            oprot.writeFieldBegin('action', TType.STRUCT, 1)
            self.action.write(oprot)
            oprot.writeFieldEnd()
        if self.predict_state is not None:
            oprot.writeFieldBegin('predict_state', TType.STRUCT, 2)
            self.predict_state.write(oprot)
            oprot.writeFieldEnd()
        if self.evaluation is not None:
            oprot.writeFieldBegin('evaluation', TType.DOUBLE, 3)
...
class BestPlannerActionRequest(object):
    ...
    def __init__(self, register_response=None, pairs=None, state=None,):
        self.register_response = register_response
        self.pairs = pairs
        self.state = state
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i117 in range(_size113):
                        ...
                        _val119 = RpcActionState()
                        _val119.read(iprot)
                        self.pairs[_key118] = _val119
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('BestPlannerActionRequest')
        if self.register_response is not None:
            oprot.writeFieldBegin('register_response', TType.STRUCT, 1)
            self.register_response.write(oprot)
            oprot.writeFieldEnd()
        if self.pairs is not None:
            oprot.writeFieldBegin('pairs', TType.MAP, 2)
            oprot.writeMapBegin(TType.I32, TType.STRUCT, len(self.pairs))
            for kiter120, viter121 in self.pairs.items():
...
class BestPlannerActionResponse(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('BestPlannerActionResponse')
        if self.index is not None:
...
State.thrift_spec = (
    ...
    (4, TType.BOOL, 'need_preprocess', None, None, ),  # 4
)
...
all_structs.append(OpponentEffector)
OpponentEffector.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'negetive_effect_by_distance', (TType.DOUBLE, None, False), None, ),  # 1
    (2, TType.BOOL, 'negetive_effect_by_distance_based_on_first_layer', None, None, ),  # 2
    (3, TType.LIST, 'negetive_effect_by_reach_steps', (TType.DOUBLE, None, False), None, ),  # 3
    (4, TType.BOOL, 'negetive_effect_by_reach_steps_based_on_first_layer', None, None, ),  # 4
)
all_structs.append(ActionTypeEffector)
ActionTypeEffector.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'direct_pass', None, None, ),  # 1
    (2, TType.DOUBLE, 'lead_pass', None, None, ),  # 2
    (3, TType.DOUBLE, 'through_pass', None, None, ),  # 3
    (4, TType.DOUBLE, 'short_dribble', None, None, ),  # 4
    (5, TType.DOUBLE, 'long_dribble', None, None, ),  # 5
    (6, TType.DOUBLE, 'cross', None, None, ),  # 6
    (7, TType.DOUBLE, 'hold', None, None, ),  # 7
)
all_structs.append(TeammateEffector)
TeammateEffector.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'coefficients', (TType.I32, None, TType.DOUBLE, None, False), None, ),  # 1
    (2, TType.BOOL, 'apply_based_on_first_layer', None, None, ),  # 2
)
all_structs.append(PlannerEvaluationEffector)
PlannerEvaluationEffector.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'opponent_effector', [OpponentEffector, None], None, ),  # 1
    (2, TType.STRUCT, 'action_type_effector', [ActionTypeEffector, None], None, ),  # 2
    (3, TType.STRUCT, 'teammate_effector', [TeammateEffector, None], None, ),  # 3
)
all_structs.append(HeliosFieldEvaluator)
HeliosFieldEvaluator.thrift_spec = (
    None,  # 0
    (1, TType.DOUBLE, 'x_coefficient', None, None, ),  # 1
    (2, TType.DOUBLE, 'ball_dist_to_goal_coefficient', None, None, ),  # 2
    (3, TType.DOUBLE, 'effective_max_ball_dist_to_goal', None, None, ),  # 3
)
all_structs.append(MatrixFieldEvaluatorY)
MatrixFieldEvaluatorY.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'evals', (TType.DOUBLE, None, False), None, ),  # 1
)
all_structs.append(MatrixFieldEvaluator)
MatrixFieldEvaluator.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'evals', (TType.STRUCT, [MatrixFieldEvaluatorY, None], False), None, ),  # 1
)
all_structs.append(PlannerFieldEvaluator)
PlannerFieldEvaluator.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'helios_field_evaluator', [HeliosFieldEvaluator, None], None, ),  # 1
    (2, TType.STRUCT, 'matrix_field_evaluator', [MatrixFieldEvaluator, None], None, ),  # 2
)
all_structs.append(PlannerEvaluation)
PlannerEvaluation.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'effectors', [PlannerEvaluationEffector, None], None, ),  # 1
    (2, TType.STRUCT, 'field_evaluators', [PlannerFieldEvaluator, None], None, ),  # 2
)
all_structs.append(HeliosOffensivePlanner)
HeliosOffensivePlanner.thrift_spec = (
    None,  # 0
    ...
    (10, TType.BOOL, 'server_side_decision', None, None, ),  # 10
    (11, TType.I32, 'max_depth', None, None, ),  # 11
    (12, TType.I32, 'max_nodes', None, None, ),  # 12
    (13, TType.STRUCT, 'evaluation', [PlannerEvaluation, None], None, ),  # 13
)
...
PlayerAction.thrift_spec = (
    ...
    (59, TType.STRUCT, 'helios_offensive_planner', [HeliosOffensivePlanner, None], None, ),  # 59
...
PlayerActions.thrift_spec = (
    ...
    (2, TType.BOOL, 'ignore_preprocess', None, None, ),  # 2
    (3, TType.BOOL, 'ignore_doforcekick', None, None, ),  # 3
    (4, TType.BOOL, 'ignore_doHeardPassRecieve', None, None, ),  # 4
    (5, TType.BOOL, 'ignore_doIntention', None, None, ),  # 5
    (6, TType.BOOL, 'ignore_shootInPreprocess', None, None, ),  # 6
)
...
all_structs.append(RpcCooperativeAction)
RpcCooperativeAction.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'category', None, None, ),  # 1
    (2, TType.I32, 'index', None, None, ),  # 2
    (3, TType.I32, 'sender_unum', None, None, ),  # 3
    (4, TType.I32, 'target_unum', None, None, ),  # 4
    (5, TType.STRUCT, 'target_point', [RpcVector2D, None], None, ),  # 5
    (6, TType.DOUBLE, 'first_ball_speed', None, None, ),  # 6
    (7, TType.DOUBLE, 'first_turn_moment', None, None, ),  # 7
    (8, TType.DOUBLE, 'first_dash_power', None, None, ),  # 8
    (9, TType.DOUBLE, 'first_dash_angle_relative', None, None, ),  # 9
    (10, TType.I32, 'duration_step', None, None, ),  # 10
    (11, TType.I32, 'kick_count', None, None, ),  # 11
    (12, TType.I32, 'turn_count', None, None, ),  # 12
    (13, TType.I32, 'dash_count', None, None, ),  # 13
    (14, TType.BOOL, 'final_action', None, None, ),  # 14
    (15, TType.STRING, 'description', 'UTF8', None, ),  # 15
    (16, TType.I32, 'parent_index', None, None, ),  # 16
)
all_structs.append(RpcPredictState)
RpcPredictState.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'spend_time', None, None, ),  # 1
    (2, TType.I32, 'ball_holder_unum', None, None, ),  # 2
    (3, TType.STRUCT, 'ball_position', [RpcVector2D, None], None, ),  # 3
    (4, TType.STRUCT, 'ball_velocity', [RpcVector2D, None], None, ),  # 4
    (5, TType.DOUBLE, 'our_defense_line_x', None, None, ),  # 5
    (6, TType.DOUBLE, 'our_offense_line_x', None, None, ),  # 6
)
all_structs.append(RpcActionState)
RpcActionState.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'action', [RpcCooperativeAction, None], None, ),  # 1
    (2, TType.STRUCT, 'predict_state', [RpcPredictState, None], None, ),  # 2
    (3, TType.DOUBLE, 'evaluation', None, None, ),  # 3
)
all_structs.append(BestPlannerActionRequest)
BestPlannerActionRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'register_response', [RegisterResponse, None], None, ),  # 1
    (2, TType.MAP, 'pairs', (TType.I32, None, TType.STRUCT, [RpcActionState, None], False), None, ),  # 2
    (3, TType.STRUCT, 'state', [State, None], None, ),  # 3
)
all_structs.append(BestPlannerActionResponse)
BestPlannerActionResponse.thrift_spec = (
    None,  # 0
