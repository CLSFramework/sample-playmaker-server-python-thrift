...
class State(object):
    def __init__(self, register_response: RegisterResponse = None, agent_type: AgentType = None, world_model: WorldModel = None, full_world_model: WorldModel = None):
        pass
...
class InitMessage(object):
    def __init__(self, register_response: RegisterResponse = None, agent_type: AgentType = None, debug_mode: bool = None):
        pass
    register_response: RegisterResponse
    agent_type: AgentType
    debug_mode: bool
