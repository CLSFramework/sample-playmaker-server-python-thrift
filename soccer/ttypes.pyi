...
class OpponentEffector(object):
    def __init__(self, negetive_effect_by_distance: List[double] = None, negetive_effect_by_distance_based_on_first_layer: bool = None, negetive_effect_by_reach_steps: List[double] = None, negetive_effect_by_reach_steps_based_on_first_layer: bool = None):
        pass
    negetive_effect_by_distance: List[double]
    negetive_effect_by_distance_based_on_first_layer: bool
    negetive_effect_by_reach_steps: List[double]
    negetive_effect_by_reach_steps_based_on_first_layer: bool

class ActionTypeEffector(object):
    def __init__(self, direct_pass: float = None, lead_pass: float = None, through_pass: float = None, short_dribble: float = None, long_dribble: float = None, cross: float = None, hold: float = None):
        pass
    direct_pass: float
    lead_pass: float
    through_pass: float
...
class TeammateEffector(object):
    def __init__(self, coefficients: Dict[int, double] = None, apply_based_on_first_layer: bool = None):
        pass
    coefficients: Dict[int, double]
    apply_based_on_first_layer: bool

class PlannerEvaluationEffector(object):
    def __init__(self, opponent_effector: OpponentEffector = None, action_type_effector: ActionTypeEffector = None, teammate_effector: TeammateEffector = None):
        pass
    opponent_effector: OpponentEffector
    action_type_effector: ActionTypeEffector
    teammate_effector: TeammateEffector

class HeliosFieldEvaluator(object):
    def __init__(self, x_coefficient: float = None, ball_dist_to_goal_coefficient: float = None, effective_max_ball_dist_to_goal: float = None):
        pass
    x_coefficient: float
    ball_dist_to_goal_coefficient: float
    effective_max_ball_dist_to_goal: float

class MatrixFieldEvaluatorY(object):
    def __init__(self, evals: List[double] = None):
        pass
    evals: List[double]

class MatrixFieldEvaluator(object):
    def __init__(self, evals: List[MatrixFieldEvaluatorY] = None):
        pass
    evals: List[MatrixFieldEvaluatorY]

class PlannerFieldEvaluator(object):
    def __init__(self, helios_field_evaluator: HeliosFieldEvaluator = None, matrix_field_evaluator: MatrixFieldEvaluator = None):
        pass
    helios_field_evaluator: HeliosFieldEvaluator
    matrix_field_evaluator: MatrixFieldEvaluator

class PlannerEvaluation(object):
    def __init__(self, effectors: PlannerEvaluationEffector = None, field_evaluators: PlannerFieldEvaluator = None):
        pass
    effectors: PlannerEvaluationEffector
    field_evaluators: PlannerFieldEvaluator

class HeliosOffensivePlanner(object):
    def __init__(self, direct_pass: bool = None, lead_pass: bool = None, through_pass: bool = None, short_dribble: bool = None, long_dribble: bool = None, cross: bool = None, simple_pass: bool = None, simple_dribble: bool = None, simple_shoot: bool = None, server_side_decision: bool = None, max_depth: int = None, max_nodes: int = None, evaluation: PlannerEvaluation = None):
        pass
    direct_pass: bool
    lead_pass: bool
    through_pass: bool
...
class PlayerActions(object):
    def __init__(self, actions: List[PlayerAction] = None, ignore_preprocess: bool = None, ignore_doforcekick: bool = None, ignore_doHeardPassRecieve: bool = None, ignore_doIntention: bool = None, ignore_shootInPreprocess: bool = None):
        pass
...
class RpcCooperativeAction(object):
    def __init__(self, category: RpcActionCategory = None, index: int = None, sender_unum: int = None, target_unum: int = None, target_point: RpcVector2D = None, first_ball_speed: float = None, first_turn_moment: float = None, first_dash_power: float = None, first_dash_angle_relative: float = None, duration_step: int = None, kick_count: int = None, turn_count: int = None, dash_count: int = None, final_action: bool = None, description: str = None, parent_index: int = None):
        pass
...
class RpcPredictState(object):
    def __init__(self, spend_time: int = None, ball_holder_unum: int = None, ball_position: RpcVector2D = None, ball_velocity: RpcVector2D = None, our_defense_line_x: float = None, our_offense_line_x: float = None):
        pass
    spend_time: int
...
class RpcActionState(object):
    def __init__(self, action: RpcCooperativeAction = None, predict_state: RpcPredictState = None, evaluation: float = None):
        pass
    action: RpcCooperativeAction
    predict_state: RpcPredictState
    evaluation: float

class BestPlannerActionRequest(object):
    def __init__(self, register_response: RegisterResponse = None, pairs: Dict[int, RpcActionState] = None, state: State = None):
        pass
    register_response: RegisterResponse
    pairs: Dict[int, RpcActionState]
    state: State

class BestPlannerActionResponse(object):
